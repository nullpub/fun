 ...
 * import * as E from "./either.ts";
 *
 * const _fetch = tryCatch(
 *   fetch,
 *   (error, arguments) => ({ message: "Fetch Error", error, arguments })
 * );
 *
 * const t1 = await _fetch("blah")();
 * assertEquals(t1.left.message, "Fetch Error");
 *
 * const t2 = await _fetch("https://deno.land/")();
 * assertEquals(t2.right.url, "https://deno.land/");
 * ```
 */
